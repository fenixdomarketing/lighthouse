...
function createExplodeyGaugeComponent(dom) {
  const el0 = dom.createFragment();
  const el1 = dom.createElement("div", "lh-exp-gauge__wrapper");
  const el2 = dom.createElement("div", "lh-exp-gauge__svg-wrapper");
  const el3 = dom.createElementNS("http://www.w3.org/2000/svg", "svg", "lh-exp-gauge");
  const el4 = dom.createElementNS("http://www.w3.org/2000/svg", "g", "lh-exp-gauge__inner");
  const el5 = dom.createElementNS("http://www.w3.org/2000/svg", "circle", "lh-exp-gauge__bg");
  const el6 = dom.createElementNS("http://www.w3.org/2000/svg", "circle", "lh-exp-gauge__base lh-exp-gauge--faded");
  const el7 = dom.createElementNS("http://www.w3.org/2000/svg", "circle", "lh-exp-gauge__arc");
  const el8 = dom.createElementNS("http://www.w3.org/2000/svg", "text", "lh-exp-gauge__percentage");
  el4.append(" ",el5," ",el6," ",el7," ",el8," ");
  const el9 = dom.createElementNS("http://www.w3.org/2000/svg", "g", "lh-exp-gauge__outer");
  const el10 = dom.createElementNS("http://www.w3.org/2000/svg", "circle", "cover");
  el9.append(" ",el10," ");
  el3.append(" ",el4," ",el9," ");
  el2.append(" ",el3," ");
  el1.append(" ",el2," ");
